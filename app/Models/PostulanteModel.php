...
class PostulanteModel extends Model
{
    ...
    protected $validationRules = [
        ...
        'cedula'                  => 'required|min_length[5]|max_length[15]',
        ...
        'estado_postulacion'      => 'required|in_list[Pendiente,Aprobada,Rechazada,Contratado]',
        ...
        'disponibilidad_inmediata' => 'required|in_list[Sí,Si,No,En 2 semanas,En 1 mes,Inmediata]',
        'expectativa_salarial'    => 'permit_empty|numeric',
