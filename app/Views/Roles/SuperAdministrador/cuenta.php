    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Mi Cuenta - Super Administrador</h4>
            </div>
        </div>
    </div>
...
document.getElementById('passwordForm').addEventListener('submit', function(e) {
    ...
    fetch('<?= base_url('super-admin/cuenta/cambiar-password') ?>', {
        method: 'POST',
        body: formData
    })
...
document.getElementById('notificacionesForm').addEventListener('submit', function(e) {
    ...
    fetch('<?= base_url('super-admin/cuenta/configurar-notificaciones') ?>', {
        method: 'POST',
        body: formData
    })
    .then(response => response.json())
...
document.getElementById('privacidadForm').addEventListener('submit', function(e) {
    ...
    fetch('<?= base_url('super-admin/cuenta/configurar-privacidad') ?>', {
        method: 'POST',
        body: formData
    })
    .then(response => response.json())
...
function cerrarSesiones() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            fetch('<?= base_url('super-admin/cuenta/cerrar-sesiones') ?>', {
                method: 'POST'
            })
            .then(response => response.json())
            .then(data => {
