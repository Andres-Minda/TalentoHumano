    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Mi Perfil - Super Administrador</h4>
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <p class="text-muted">Super Administrador</p>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="mb-1">Usuarios Gestionados</h6>
                            <small class="text-muted">Hoy: <?= $usuariosGestionados ?? 0 ?></small>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                        <div class="flex-shrink-0">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="mb-1">Roles Configurados</h6>
                            <small class="text-muted">Total: <?= $rolesConfigurados ?? 0 ?></small>
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <small class="text-muted">Total: <?= $departamentosGestionados ?? 0 ?></small>
                        </div>
                    </div>
                </div>
            </div>
...
function cambiarFoto(input) {
    if (input.files && input.files[0]) {
        ...
        // Aquí se podría implementar la subida de la imagen
        Swal.fire({
            icon: 'success',
...
function guardarPerfil() {
    ...
    fetch('<?= base_url('super-admin/perfil/actualizar') ?>', {
        method: 'POST',
        body: formData
    })
