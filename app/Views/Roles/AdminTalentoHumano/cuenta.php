...
document.getElementById('passwordForm').addEventListener('submit', function(e) {
    ...
    fetch('<?= base_url('admin-th/cuenta/cambiar-password') ?>', {
        method: 'POST',
        body: formData
    })
...
document.getElementById('notificacionesForm').addEventListener('submit', function(e) {
    ...
    fetch('<?= base_url('admin-th/cuenta/configurar-notificaciones') ?>', {
        method: 'POST',
        body: formData
    })
    .then(response => response.json())
...
document.getElementById('privacidadForm').addEventListener('submit', function(e) {
    ...
    fetch('<?= base_url('admin-th/cuenta/configurar-privacidad') ?>', {
        method: 'POST',
        body: formData
    })
    .then(response => response.json())
...
function cerrarSesiones() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            fetch('<?= base_url('admin-th/cuenta/cerrar-sesiones') ?>', {
                method: 'POST'
            })
            .then(response => response.json())
            .then(data => {
