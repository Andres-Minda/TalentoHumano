            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-center">Página de gestión de empleados - Administrador Talento Humano</p>
                        
                        <div class="alert alert-info">
                            <i class="bi bi-info-circle"></i>
                            <strong>Funcionalidad:</strong> Aquí se mostrará la lista de empleados con opciones para crear, editar y gestionar la información laboral.
                        </div>
                    </div>
                </div>
            </div>
