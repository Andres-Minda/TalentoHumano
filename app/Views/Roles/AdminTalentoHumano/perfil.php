        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <p class="text-muted">Administrador Talento Humano</p>
                    <div class="d-flex justify-content-center gap-2">
                        <span class="badge bg-success">Admin TH</span>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <small class="text-muted">Hoy: <?= $empleadosGestionados ?? 0 ?></small>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                        <div class="flex-shrink-0">
                            <div class="avatar-sm rounded-circle bg-success">
                                <span class="avatar-title text-white">
                                    <i class="ti ti-cash-stack"></i>
                                </span>
                            </div>
                        </div>
                        <div class="flex-grow-1 ms-3">
                            <h6 class="mb-1">Nóminas Procesadas</h6>
                            <small class="text-muted">Este mes: <?= $nominasProcesadas ?? 0 ?></small>
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
...
function guardarPerfil() {
    ...
    fetch('<?= base_url('admin-th/perfil/actualizar') ?>', {
        method: 'POST',
        body: formData
    })
