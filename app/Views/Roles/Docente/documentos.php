...
function subirDocumento() {
    ...
    fetch('<?= base_url('index.php/empleado/documentos/subir') ?>', {
        method: 'POST',
        body: formData
    })
...
function verDocumento(idDocumento) {
    fetch(`<?= base_url('index.php/empleado/documentos/ver/') ?>${idDocumento}`)
    .then(response => response.json())
    .then(data => {
        if (data.success) {
...
function descargarDocumento(idDocumento) {
    window.open(`<?= base_url('index.php/empleado/documentos/descargar/') ?>${idDocumento}`, '_blank');
}
...
function eliminarDocumento(idDocumento) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            fetch(`<?= base_url('index.php/empleado/documentos/eliminar/') ?>${idDocumento}`, {
                method: 'POST'
            })
            .then(response => response.json())
            .then(data => {
