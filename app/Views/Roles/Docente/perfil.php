            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-center">Página de mi perfil - Docente</p>
                        
                        <div class="alert alert-info">
                            <i class="bi bi-info-circle"></i>
                            <strong>Funcionalidad:</strong> Aquí se mostrará la información personal del docente con opciones para editar datos personales y laborales.
                        </div>
                    </div>
                </div>
            </div>
