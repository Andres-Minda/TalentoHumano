...
<head>
    ...
    <title>Iniciar Sesión | Talento Humano</title>
        ...
        <div class="login-card card w-100">
            <div class="card-body">
                <div class="text-center mb-3">
                    ...
                    <h1 class="login-title">Talento Humano</h1>
                    <div class="login-subtitle">Por favor, inicie sesión para continuar</div>
                </div>
                <form action="<?= site_url('auth/attemptLogin') ?>" method="post" id="loginForm" autocomplete="off" novalidate>
                    <?= csrf_field() ?>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="identificador" name="identificador" placeholder="Cédula o Correo" required autofocus
                            data-bs-toggle="tooltip" data-bs-placement="right" title="Ingrese su cédula o correo electrónico">
