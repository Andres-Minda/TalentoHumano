    ...
    <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="<?= base_url('index.php/empleado/mis-solicitudes/vacaciones') ?>" aria-expanded="false">
                        <span><i class="bi bi-airplane"></i></span>
                        <span class="hide-menu">Vacaciones</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="<?= base_url('index.php/empleado/mis-solicitudes/permisos') ?>" aria-expanded="false">
